...
const projects = [
  {
    id: 1,
    title: "Chatbot Educatif Multilingue",
    status: "En cours",
    statusColor: "#22d3ee",
    category: "AI / NLP",
    ...
    highlights: [
      ...
      "Transposable en chatbot service client",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Architecture transposable a la surveillance reseau",
    ],
